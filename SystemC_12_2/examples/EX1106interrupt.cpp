...
//                                                                            //
// File name   : EX1106interrupt.cpp                                          //
// Title       : Debugging C++ Code                                           //
// Project     : SystemC Language Fundamentals                                //
// Description : Demonstrates sc_interrupt_here()                             //
...
int sc_main (int argc, char**argv) {
  ...
  sc_report_handler::set_actions("My message type",SC_DEFAULT_WARNING_ACTIONS | SC_INTERRUPT);
