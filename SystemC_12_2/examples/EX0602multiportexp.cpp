...
//                                                                            //
// File name   : EX0602multiportexp.cpp                                       //
// Title       : The sc_port Class Template                                   //
// Project     : SystemC Language Fundamentals                                //
// Description : Demonstrates use of multiport with explicit binding          //
...
SC_MODULE ( top ) {
    ...
    consumer_inst ( "consumer_inst" )
  {
    ...
    producer_inst.p_out ( signal0 ) ;
    producer_inst.p_out ( signal1 ) ;
    consumer_inst.p_in  ( signal0 ) ;
    consumer_inst.p_in  ( signal1 ) ;
