...
//                                                                            //
// File name   : EX0602portarrayexp.cpp                                       //
// Title       : The sc_port Class Template                                   //
// Project     : SystemC Language Fundamentals                                //
// Description : Demonstrates use of port array with explicit binding         //
...
SC_MODULE ( top ) {
    ...
    consumer_inst ( "consumer_inst" )
  {
    ...
    producer_inst.p_out [0] ( signal0 ) ;
    producer_inst.p_out [1] ( signal1 ) ;
    consumer_inst.p_in  [0] ( signal0 ) ;
    consumer_inst.p_in  [1] ( signal1 ) ;
